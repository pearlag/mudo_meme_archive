...
function SavedPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SavedPage.useEffect": ()=>{
            const { data: { subscription } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "SavedPage.useEffect": (event, session)=>{
                    setSession(session);
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession().then({
                "SavedPage.useEffect": ({ data: { session } })=>{
                    setSession(session);
                    setUser(session?.user ?? null);
                }
            }["SavedPage.useEffect"]);
            return ({
                "SavedPage.useEffect": ()=>subscription.unsubscribe()
            })["SavedPage.useEffect"];
        }
    }["SavedPage.useEffect"], []);
    ...
    const filteredMemes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SavedPage.useMemo[filteredMemes]": ()=>{
            return memes.filter({
                "SavedPage.useMemo[filteredMemes]": (meme)=>{
                    const matchesSearch = meme.title.toLowerCase().includes(searchQuery.toLowerCase()) || meme.quote.toLowerCase().includes(searchQuery.toLowerCase()) || meme.tags.some({
                        "SavedPage.useMemo[filteredMemes]": (tag)=>tag.toLowerCase().includes(searchQuery.toLowerCase())
                    }["SavedPage.useMemo[filteredMemes]"]);
...
_s(SavedPage, "5tT50thlFqpkY0Kkx6RcyL1b4Fc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useUserRole$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserRole"]
    ];
...
//# sourceMappingURL=src_e64e8b0d._.js.map